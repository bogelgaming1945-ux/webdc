...
--- ===========================
local SecretFish = {
    "Crystal Crab", "Orca", "Blob Shark", "Skeleton Narwhal", 
    "Ghost Shark", "Worm Fish", "Bloodmoon Whale", "Megalodon",
    "Lochness Monster", "Ancient Magma Whale", "Eerie Shark",
    "Thin Armor Shark", "Great Whale", "Frostborn Shark",
    "King Crab", "Queen Crab", "Cryoshade Glider", "Phanter Eel",
